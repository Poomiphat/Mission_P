...
if you use the PC in robot room@AIC you can Follow the steps below, If not you should to install node-red and important palette [Link Text](#software-component) on your laptop and After intall import "Proect-Demo.json" in your node-red
